...
@section('content')
  <div class="card p-5" style="width: 100%; height: 100%;">
    ...
    <div class="text-center" id="contenedor-sin_datos_encontrados">
      <img src="{{ asset('images/doctor_not_found.png') }}" width="300" alt="Logo" style="opacity: 0.2;">
    </div>

    <div class="d-none" id="contenedor-datos_registro_paciente">
      <div class="divider">
