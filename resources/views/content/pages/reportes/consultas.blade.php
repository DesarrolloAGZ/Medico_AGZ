...
@section('title', 'Reporte consultas')

@section('page-style')
@endsection

@section('page-script')
  <script src="{{ asset('assets/js/reportes/consultas.js') }}?v={{ date('YmdHis')}}"></script>
  <script>
...
<div class="card p-5">
  ...
  <div class="divider">
    <div class="divider-text texto-titulo">Reporte de consultas</div><br>
  </div>

  <form id="form-reporte_consultas" method="POST" enctype="multipart/form-data" onSubmit="return false">

    <div class="divider text-start">
      <div class="divider-text"><span class="mdi mdi-filter-multiple me-2"></span>Filtros para generar reporte de consultas</div>
    </div>
    ...
    <div class="row mt-2 mb-4">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
        <div class="form-floating form-floating-outline mb-6">
          <select class="form-select select2" id="filtro-tipo_visita">
            <option value="" selected disabled>Selecciona una opción</option>
            @foreach ($datos_vista['catalogos']['tipo_visita'] as $tipo_visita)
              <option value="{{ $tipo_visita['id'] }}">{{ $tipo_visita['nombre'] }}</option>
            @endforeach
          </select>
          <label for="filtro-tipo_visita">Tipo visita de consulta</label>
        </div>
      </div>
      <div class="col-lg-1 col-md-1 col-sm-12 mb-3" style="text-align: end;">
        <button type="button" class="btn btn-sm btn-secondary mb-3" id="boton-limpiar_filtros_reporte_consultas">
    ...
    <div class="row">
      <div class="col-md-12" style="text-align: end;">
        <button type="button" class="btn btn-sm btn-primary mb-3" id="boton-seleccionar_todas_columnas_reporte_consultas">
          Seleccionar todas
        </button>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="motivo_consulta" value="motivo_consulta" />
          <label class="form-check-label" for="motivo_consulta">Motivo de consulta</label>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="cie_nombre" value="cie_nombre" />
          <label class="form-check-label" for="cie_nombre">CIE10</label>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="temperatura" value="temperatura" />
          <label class="form-check-label" for="temperatura">Temperatura</label>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="peso" value="peso" />
          <label class="form-check-label" for="peso">Peso</label>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="altura" value="altura" />
          <label class="form-check-label" for="altura">Altura</label>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="imc" value="imc" />
          <label class="form-check-label" for="imc">IMC</label>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="frecuencia_cardiaca" value="frecuencia_cardiaca" />
          <label class="form-check-label" for="frecuencia_cardiaca">Frecuencia cardiaca</label>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="saturacion_oxigeno" value="saturacion_oxigeno" />
          <label class="form-check-label" for="saturacion_oxigeno">Saturación de oxígeno</label>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="presion_arterial" value="presion_arterial" />
          <label class="form-check-label" for="presion_arterial">Presión arterial</label>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="observaciones" value="observaciones" />
          <label class="form-check-label" for="observaciones">Observaciones</label>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="tipo_visita" value="tipo_visita" />
          <label class="form-check-label" for="tipo_visita">Tipo de visita</label>
        </div>
      </div>
  ...
  <div class="row mt-4">
    <div class="col-md-12" style="text-align: center">
      <button id="boton-generar_reporte_consultas" type="button" class="btn btn-success"><span class="mdi mdi-file-excel me-2"></span>Generar reporte</button>
    </div>
  </div>
