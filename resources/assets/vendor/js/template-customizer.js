...
TemplateCustomizer.LANGUAGES = {
  en: {
    panel_header: 'Personalización del sitio',
    panel_sub_header: 'Personaliza el sitio a tu gusto',
    ...
    layout_offcanvas: 'Fuera del lienzo',
    layout_fixed: 'Fijo',
    layout_fixed_offcanvas: 'Fijo fuera del lienzo',
